...
export const CountryPicker = (props) => {
    ...
    useEffect(() => {
        getCountriesAsync(withEmoji ? FlagType.EMOJI : FlagType.FLAT, translation, region, subregion, countryCodes, excludeCountries, preferredCountries, withAlphaFilter, useNationality)
            .then(setCountries)
            .catch(console.warn);
